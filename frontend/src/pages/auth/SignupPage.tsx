...
import {
  TrendingUp, Eye, EyeOff, ArrowRight, Mail, Lock, User,
...
const BrandPanel: React.FC = () => (
  <div className="hidden lg:flex flex-col justify-between bg-gradient-to-br from-slate-900 via-slate-950 to-blue-950 p-12 xl:p-16 relative overflow-hidden text-white border-r border-slate-800/80">
    {/* Ambient radial glows */}
    <div
      className="absolute top-1/4 -right-20 w-[480px] h-[480px] pointer-events-none rounded-full blur-3xl opacity-30"
      style={{ background: 'radial-gradient(circle, #3b82f6 0%, transparent 70%)' }}
    />
    <div
      className="absolute -bottom-20 -left-20 w-[420px] h-[420px] pointer-events-none rounded-full blur-3xl opacity-20"
    ...
    <div className="relative z-10 my-auto py-8 space-y-8 max-w-xl">
      ...
      <div className="space-y-3.5">
        ...
        <motion.div
          ...
          className="bg-slate-900/90 border border-slate-800/80 rounded-2xl p-5 shadow-2xl backdrop-blur-xl hover:border-slate-700/80 transition-all"
        >
        ...
        <motion.div
          ...
          className="bg-slate-900/90 border border-slate-800/80 rounded-2xl p-4 shadow-2xl backdrop-blur-xl flex items-start gap-3.5 hover:border-slate-700/80 transition-all"
        >
        ...
        >
          ...
          {success ? (
            ...
            <div className="w-full">
              ...
              <button
                ...
                disabled={loading}
                className="w-full flex items-center justify-center gap-3 px-4 py-3.5 border border-slate-200 hover:border-slate-300 rounded-2xl text-slate-700 hover:bg-slate-50/80 transition-all font-semibold shadow-sm mb-5 active:scale-[0.99]"
              >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      autoComplete="name"
                      className={`w-full pl-12 pr-4 py-3.5 text-[15px] text-slate-900 bg-white border rounded-2xl outline-none focus:border-blue-600 focus:ring-4 focus:ring-blue-500/10 transition-all ${
                        errors.fullName
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      className={`w-full pl-12 pr-12 py-3.5 text-[15px] text-slate-900 bg-white border rounded-2xl outline-none focus:border-blue-600 focus:ring-4 focus:ring-blue-500/10 transition-all ${
                        errors.password
                          ? 'border-red-300 bg-red-50/50 focus:border-red-500'
                          : 'border-slate-200 hover:border-slate-300'
                      }`}
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full flex items-center justify-center gap-2 py-3.5 text-[15.5px] font-bold text-white bg-gradient-to-r from-blue-600 via-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 rounded-2xl transition-all shadow-lg shadow-blue-500/25 active:scale-[0.99] disabled:opacity-60"
                >
                  {loading
          ...
          <div className="mt-5 space-y-4">
            ...
            <button
              onClick={handleDemo}
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 py-3.5 text-[14.5px] font-bold text-blue-700 bg-gradient-to-r from-blue-50 via-indigo-50 to-blue-50 hover:from-blue-100 hover:to-indigo-100 border border-blue-200/70 rounded-2xl transition-all shadow-sm active:scale-[0.99]"
            >
