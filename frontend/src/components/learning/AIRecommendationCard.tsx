...
export const AIRecommendationCard: React.FC = () => {
  ...
  return (
    <motion.div
      whileHover={{ y: -2 }}
      className="p-6 rounded-3xl bg-gradient-to-br from-blue-50/80 via-indigo-50/40 to-purple-50/50 border border-blue-200/80 shadow-xs mb-8 space-y-3 relative overflow-hidden"
    >
