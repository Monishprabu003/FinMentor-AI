...
export const LearningHero = () => {
    ...
    const goalPercentage = Math.min(100, Math.round((MOCK_USER_STATS.todayCompletedMinutes / MOCK_USER_STATS.todayGoalMinutes) * 100));
    return (<div className="relative rounded-3xl bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 text-white p-6 md:p-8 shadow-xl overflow-hidden mb-8">
        ...
        <div className="p-6 rounded-2xl bg-white/10 border border-white/15 backdrop-blur-md text-center space-y-3 flex flex-col items-center justify-center">
          ...
          <div className="relative w-28 h-28 my-1 flex items-center justify-center">
            <svg className="w-full h-full transform -rotate-90" viewBox="0 0 36 36">
              ...
              <motion.path className="text-blue-400" strokeWidth="3.5" strokeDasharray={`${goalPercentage}, 100`} strokeLinecap="round" stroke="currentColor" fill="none" initial={{ strokeDasharray: '0, 100' }} animate={{ strokeDasharray: `${goalPercentage}, 100` }} transition={{ duration: 1.5, ease: 'easeOut' }} d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831"/>
            </svg>
