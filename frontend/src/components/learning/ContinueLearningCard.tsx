...
export const ContinueLearningCard: React.FC = () => {
  ...
  return (
    <motion.div
      whileHover={{ y: -2 }}
      className="p-6 rounded-3xl bg-white border border-slate-200 shadow-sm space-y-4 mb-8"
    >
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        ...
        <button
          onClick={() => navigate(`/dashboard/learning/course/${currentCourse.id}`)}
          className="w-full md:w-auto px-6 py-3.5 rounded-2xl bg-blue-600 hover:bg-blue-700 text-white font-extrabold text-xs shadow-md shadow-blue-600/20 flex items-center justify-center gap-2 transition-all hover:scale-[1.02] shrink-0"
        >
      ...
      <div className="space-y-1.5 pt-2">
        ...
        <div className="w-full h-2.5 bg-slate-100 rounded-full overflow-hidden">
          <motion.div
            ...
            initial={{ width: 0 }}
            animate={{ width: `${currentCourse.progressPercentage}%` }}
