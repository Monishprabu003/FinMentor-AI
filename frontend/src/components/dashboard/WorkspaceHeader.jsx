...
export const WorkspaceHeader = () => {
    ...
    return (<motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-5">
      {/* Date */}
      ...
      <motion.div variants={itemVariants} className="flex flex-wrap gap-2 pt-1">
        ...
        {FOCUS_ITEMS.map(({ icon: Icon, label, color }) => (<motion.button key={label} whileHover={{ scale: 1.03, y: -1 }} whileTap={{ scale: 0.97 }} className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white border border-slate-200 hover:border-blue-300 hover:bg-blue-50 shadow-sm transition-all duration-200 cursor-default">
