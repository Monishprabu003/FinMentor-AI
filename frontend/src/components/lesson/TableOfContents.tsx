...
export const TableOfContents: React.FC<TableOfContentsProps> = ({ items }) => {
  ...
  return (
    <div className="w-64 shrink-0 hidden xl:block sticky top-20 space-y-3 self-start">
        ...
        {items.map((item) => {
          ...
          return (
            <button
              ...
              className={`block w-full text-left text-xs font-semibold transition-all py-1.5 px-2 rounded-lg ${
                isActive
