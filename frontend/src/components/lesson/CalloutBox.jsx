...
export const CalloutBox = ({ type, title, text, formulaCode }) => {
    const configs = {
        tip: {
    ...
    return (<div className={`p-5 rounded-2xl border ${cfg.bg} space-y-2 my-6 shadow-sm`}>
      ...
      {formulaCode && (<div className="mt-3 p-3 rounded-xl bg-zinc-950 border border-zinc-800 font-mono text-xs text-indigo-300 overflow-x-auto">
