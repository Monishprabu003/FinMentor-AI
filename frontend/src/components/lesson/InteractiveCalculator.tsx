...
import type { InteractiveCalculatorConfig } from '../../types/course';

interface InteractiveCalculatorProps {
  config: InteractiveCalculatorConfig;
}

export const InteractiveCalculator: React.FC<InteractiveCalculatorProps> = ({ config }) => {
  const [income, setIncome] = useState<number>(config.defaultIncome || 75000);
  ...
  return (
    <div className="p-6 rounded-3xl bg-zinc-900 border border-zinc-800 text-zinc-100 space-y-6 my-8 shadow-xl relative overflow-hidden">
      {/* Background glow */}
