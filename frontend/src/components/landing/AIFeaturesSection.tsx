          ...
          <div className="bg-white border border-gray-100 rounded-2xl p-4 shadow-sm">
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={g} className="flex items-center gap-2.5 text-[13px] text-slate-600 font-medium">
        ...
        <div className="space-y-4">
          {aiFeatures.map((f, i) => (
            <motion.div
              ...
              className="bg-white rounded-2xl border border-gray-100 p-6 hover:border-blue-100 hover:shadow-md transition-all duration-200"
            >
