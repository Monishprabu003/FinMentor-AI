...
export const LandingFooter = () => (<footer className="bg-white border-t border-gray-100">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-8">
        ...
        <div className="col-span-2 sm:col-span-3 lg:col-span-1 space-y-4">
          ...
          <div className="flex gap-2">
            {[Globe, Code2, Users].map((Icon, i) => (<a key={i} href="#" className="w-8 h-8 rounded-lg border border-gray-100 bg-slate-50 hover:border-blue-200 hover:bg-blue-50 flex items-center justify-center transition-all">
