  ...
  return (
    <div className="max-w-xl space-y-8 relative z-10">
      ...
      <motion.div
        ...
        className="inline-flex items-center gap-2.5 bg-white border border-blue-100/90 shadow-sm rounded-2xl px-4 py-2"
      >
      ...
      <div className="space-y-1">
        {[
          ...
          <motion.h1
            ...
            className={`text-[64px] sm:text-[76px] xl:text-[84px] font-black leading-[0.94] tracking-tight ${color}`}
          >
            {text}
          </motion.h1>
        ))}
      ...
      <motion.p
        ...
        className="text-[16.5px] text-slate-500 leading-relaxed font-normal"
      >
      ...
      >
        <button
          ...
          className="flex items-center gap-2.5 px-8 py-4 text-[16px] font-bold text-white bg-blue-600 hover:bg-blue-700 rounded-full transition-all shadow-lg shadow-blue-600/25 hover:shadow-xl hover:shadow-blue-600/30 active:scale-[0.98] cursor-pointer"
        >
