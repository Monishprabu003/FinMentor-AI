...
export const AICore: React.FC = () => (
  <div className="relative flex items-center justify-center pointer-events-none select-none z-10">
    ...
    <motion.div
      className="absolute w-44 h-44 rounded-full bg-blue-600/20 border border-blue-500/30"
    ...
    <motion.div
      className="absolute w-56 h-56 rounded-full bg-indigo-500/15 border border-indigo-400/20"
    ...
    <div className="w-36 h-36 rounded-full p-2.5 bg-gradient-to-br from-blue-500/20 via-indigo-500/10 to-blue-600/20 backdrop-blur-md border border-blue-300/40 shadow-[0_0_50px_rgba(37,99,235,0.3)] flex items-center justify-center">
      ...
      <motion.div
        className="w-full h-full rounded-full bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-700 border border-blue-400/50 shadow-xl flex flex-col items-center justify-center text-white relative overflow-hidden"
        animate={{ scale: [1, 1.04, 1] }}
        transition={{ duration: 2.4, repeat: Infinity, ease: 'easeInOut' }}
      >
        {/* Internal metallic light beam overlay */}
        <div
          className="absolute -right-6 -top-6 w-24 h-24 rounded-full pointer-events-none opacity-40 blur-xl"
