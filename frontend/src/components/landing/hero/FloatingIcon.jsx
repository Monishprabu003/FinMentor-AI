...
export const FloatingIcon = () => (<div className="absolute inset-0 pointer-events-none overflow-hidden z-0" aria-hidden="true">
    {ICONS.map((item, i) => {
        const { Icon, x, y, size, delay, duration, rotate } = item;
        return (<motion.div key={i} className="absolute" style={{ left: x, top: y }} animate={{
                y: [0, -16, 8, -20, 0],
                x: [0, 10, -6, 12, 0],
