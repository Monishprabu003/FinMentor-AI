...
interface OrbitRingProps {
  ...
  duration?: number;
  reverse?: boolean;
  nodes?: { angle: number; color?: string; label?: string }[];
  borderDash?: string;
  opacity?: number;
}
...
export const OrbitRing: React.FC<OrbitRingProps> = ({
  ...
  return (
    <div
      className="absolute top-1/2 left-1/2 pointer-events-none -translate-x-1/2 -translate-y-1/2 rounded-full border border-blue-400/30"
      style={{
        width: size,
        height: size,
