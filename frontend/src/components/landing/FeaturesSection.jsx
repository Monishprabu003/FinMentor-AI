...
import { CreditCard, PieChart, Target, Bot, BarChart2, GraduationCap, Activity, ShieldCheck } from 'lucide-react';
const features = [
...
export const FeaturesSection = () => (<section id="features" className="py-24 bg-white">
    <div className="max-w-7xl mx-auto px-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-16">
        ...
        <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.1 }} className="text-[15px] text-slate-500 max-w-xs leading-relaxed">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        return (<motion.div key={f.title} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.05, duration: 0.4 }} whileHover={{ y: -5, boxShadow: '0 16px 48px rgba(0,0,0,0.08)' }} className={`p-6 rounded-2xl border border-gray-100 bg-white ring-2 ring-transparent ${c.ring} transition-all duration-200 cursor-default`}>
