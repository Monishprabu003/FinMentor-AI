...
export const AIHero: React.FC = () => {
  ...
  return (
    <div className="relative rounded-3xl bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 text-white p-6 md:p-8 shadow-xl overflow-hidden mb-6">
      {/* Glow animations */}
        ...
        <div className="space-y-3 max-w-xl">
          ...
          <div className="flex flex-wrap items-center gap-3 pt-2">
            <button
              ...
              className="px-6 py-3 rounded-2xl bg-blue-600 hover:bg-blue-500 text-white font-extrabold text-xs shadow-lg shadow-blue-600/20 flex items-center gap-2 transition-all hover:scale-102 cursor-pointer"
            >
            ...
            <button
              onClick={() => navigate('/dashboard/learning/course/course-1/lesson/l4')}
              className="px-5 py-3 rounded-2xl bg-white/10 hover:bg-white/20 border border-white/15 text-white font-extrabold text-xs flex items-center gap-1.5 transition-all"
            >
