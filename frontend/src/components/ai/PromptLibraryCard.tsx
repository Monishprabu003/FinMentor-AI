...
export const PromptLibraryCard: React.FC<PromptLibraryCardProps> = ({ prompt, onUsePrompt }) => {
  return (
    <motion.div
      whileHover={{ y: -3 }}
    ...
    >
      ...
      <div className="pt-3 mt-3 border-t border-slate-100 flex items-center justify-between">
        <button
          onClick={() => onUsePrompt(prompt.promptText)}
          className="w-full py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-extrabold text-xs flex items-center justify-center gap-1.5 transition-all"
        >
