    ...
    <div className="w-64 shrink-0 hidden lg:block space-y-4">
      <div className="p-5 rounded-3xl bg-zinc-900 border border-zinc-800 text-zinc-100 shadow-xl space-y-4">
        ...
        <button
          ...
          className="w-full py-3 rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-extrabold text-xs shadow-lg shadow-blue-600/20 transition-all hover:scale-102 cursor-pointer"
        >
          Submit & Finish Exam
        </button>
      </div>
