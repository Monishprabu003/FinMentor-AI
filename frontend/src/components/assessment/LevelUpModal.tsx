      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
          <motion.div
            ...
            className="w-full max-w-md bg-zinc-950 border border-zinc-800 rounded-3xl p-6 text-center space-y-5 text-zinc-100 shadow-2xl relative overflow-hidden"
          >
            {/* Background Glow */}
              ...
              <div className="p-4 rounded-2xl bg-zinc-900 border border-zinc-800 space-y-2">
                ...
                <div className="flex flex-wrap justify-center gap-2">
                  {badgesUnlocked.map((badge, i) => (
                    <span key={i} className="text-xs font-bold px-3 py-1 rounded-full bg-amber-500/20 text-amber-300 border border-amber-400/30 flex items-center gap-1">
